 ...
 */
function jp_scripts() {
	wp_enqueue_style( 'jp-css', get_template_directory_uri() . '/assets/css/site.css');

	wp_enqueue_script( 'jp-js', get_stylesheet_directory_uri() . '/assets/js/site.js', array( 'jquery' ), true );
}
